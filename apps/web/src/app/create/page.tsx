  ...
  return (
    <div className="page-shell py-14 md:py-20">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="mt-5 text-base leading-7 text-[#56506a]">
          Your NFT is escrowed when the raffle is created. Ticket price,
          threshold, sale window, fees, and both settlement branches cannot be
          changed afterward.
        </p>
      </div>
      <CreateRaffleForm />
